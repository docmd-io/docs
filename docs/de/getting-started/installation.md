...
<!-- SCREENSHOT: Terminalausgabe eines erfolgreichen `npx docmd init`-Laufs — der generierte Dateibaum mit docmd.config.js, docs/index.md und der 'Ready!'-Nachricht. -->

::: callout tip "Nach der lokalen Installation"
Sobald `@docmd/core` eine Projektabhängigkeit ist, verwenden Sie `npx docmd` anstelle von `npx @docmd/core` für alle Befehle.
:::
