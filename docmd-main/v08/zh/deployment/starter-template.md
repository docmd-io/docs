---
title: "入门模板 (Starter Template)"
description: "使用官方 docmd 入门模板，在不到一分钟内创建一个预配置的文档站点并自动部署到 GitHub Pages。"
---
...
完整的导航配置请参阅 [导航配置 (Navigation Configuration)](../configuration/navigation.md)。
...
模板从一开始就让您完全拥有工作流文件和配置的所有权。[GitHub Action](./github-action) 更适合在不重构现有仓库的前提下为其添加 docmd 部署。
