...
`packages/plugins/okf/tests/index.test.ts`（6 个测试）+ `packages/plugins/okf/tests/brute.test.ts`（15 个测试），包括 12 个真实 fs 场景。**21/21 通过**。
...
| `packages/plugins/okf` | 21 / 21 | 单元 + 12 个真实 fs 场景 |
