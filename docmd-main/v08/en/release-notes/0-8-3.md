...
docmd v0.8.3 is a major architectural update that introduces **Workspaces**, enabling centralized management of multiple documentation projects. This release also prioritises **Security & Stability** with hardened rendering across the ecosystem and improved routing reliability.
...
- **Improved Search Safety**: Search results now use a more reliable rendering pipeline to ensure content is always handled securely.
