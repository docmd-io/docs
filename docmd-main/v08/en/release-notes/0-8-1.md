...
The Rust engine is in preview. In the initial **v0.8.1 rollout**, pre-compiled native binaries are exclusively published for **macOS ARM64 (Apple Silicon)** platforms. Builds executed on other architectures automatically and transparently fallback to the high-performance JS engine. Internal benchmarks show a **~25% improvement on cold builds** and **~17% on warm builds** for an 886-page multi-project site.
:::
