...
To enable seamless documentation ingestion by AI assistants, we have introduced two new localized buttons next to page breadcrumbs:
...
- **Copy Context**: Copies structured context containing the page URL, title, tags, version, and text, optimized for direct copy-pasting into AI chat windows.
- **Localization**: Supports translations and copied confirmations for all 7 primary languages (`en`, `de`, `es`, `fr`, `hi`, `ja`, `zh`).
