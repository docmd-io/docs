...
Site-URL geändert oder SPA-Modus umgeschaltet? Führen Sie `docmd deploy --nginx` erneut aus - die Konfiguration wird neu generiert, um Ihre aktuelle `docmd.config.json` widerzuspiegeln.