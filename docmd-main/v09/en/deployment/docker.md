...
We recommend pinning a specific version (e.g. `0.9.0`) for reproducible builds. The `:latest` tag is published automatically starting with 0.9.0, but for production pipelines you should always pin a specific release.
:::
