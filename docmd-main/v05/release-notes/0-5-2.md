...
This release introduces the much-anticipated **Menubar** component, significantly hardens the **Zero-Config** engine, and transforms the developer experience with a reliable dev server and a built-in playground.
...
- **Reliable Rebuilds**: Fixed issues where `pnpm dev` would fail during active development. The internal watcher is now smarter about tracking core utility changes.
