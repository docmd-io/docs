...
## 🛡️ Sicherheit
- **Abhängigkeits-Audit**: Mehrere Sicherheitshinweise wurden behoben, indem tief verschachtelte Unterabhängigkeiten im gesamten Monorepo (`cross-spawn`, `dompurify`, `lodash-es`, `uuid` und `mermaid`) zwangsweise aktualisiert wurden. Das gesamte Engine-Ökosystem ist nun zu 100 % sauber und frei von Schwachstellen.
