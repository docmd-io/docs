...
::: callout tip "Scales with your documentation"
...
If you were using `editLink.baseUrl` with a hardcoded subdirectory (e.g. `.../edit/main/docs`), that directory segment is now computed automatically. Switching to the git plugin requires removing the subdirectory from the URL — use just `https://github.com/org/repo` as the `repo` value.
:::
