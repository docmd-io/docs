...
- **Search result version badges**: Search results now display version badges as color-coded pills aligned to the right of the result title. Each version gets a deterministic colour generated at build time for easy visual identification.
