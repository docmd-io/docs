...
- **Color-Coded Tags**: Each version tag is automatically assigned a unique, aesthetically pleasing colour from a predefined palette to help users visually distinguish between different documentation silos.
