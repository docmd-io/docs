...
::: card "可扩展的Werkzeug-System" icon:wrench
...
| 页面 | 说明 |
| :--- | :---------- |
| [Erste Schritte](getting-started) | 安装、设置与首次对话轮次 |
| [Engine-Architektur](how-it-works) | 轮次执行管道、上下文组装与事件总线 |
| [Konfiguration](configuration) | 初始化参数、运行时更新与系统 Prompt |
| [Werkzeug-System](tools) | 创建自定义工具、标准工具与页面读取器 |
| [Programmierbare API](api) | `DocmdAssistantEngine` 类参考与类型定义 |
